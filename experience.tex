% \newpage
\section{Skills}
\cvline{}{Language : C/C++, and Java}
\cvline{}{Android application development}
\cvline{}{Embedded system development on Raspberry Pi}
\cvline{}{Parallel programming and performance tuning : MPI, pthread, OpenMP, CUDA}
