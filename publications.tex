...
%\bibitem{SMARTCITY15}
%S. Wang, \bibauthor{C. Fan}, Y. Huang, C. Hsu.
%\newblock \emph{Toward Optimal Crowdsensing Video Quality for Wearable Cameras in Smart Cities}.
%\newblock in \emph{ Proc. of International Workshop on Smart Cities and Urban Informatics (SmartCity ’15)}, Hong Kong, China, April 2015.

%\bibitem{MM15beholder}
%C. Huang, C. Hsu, T. Tsai, \bibauthor{C. Fan}, C. Hsu, K. Chen.
%\newblock \emph{Smart Beholder: An Open-Source Smart Lens for Mobile Photography}.
%\newblock Submitted to \emph{ Proc. of ACM International Conference on Multimedia (Multimedia’15)}, Brisbane, Australia, October 2015.
